...
class TaskBoard extends _TaskBoard
  ...
  TaskBoard(
    ...
    RealmObjectBase.set(this, 'id', id);
    RealmObjectBase.set(this, 'tittle', tittle);
  ...
  @override
  String get tittle => RealmObjectBase.get<String>(this, 'tittle') as String;
  @override
  set tittle(String value) => RealmObjectBase.set(this, 'tittle', value);
  ...
  static SchemaObject _initSchema() {
    ...
    return const SchemaObject(ObjectType.realmObject, TaskBoard, 'TaskBoard', [
      SchemaProperty('id', RealmPropertyType.uuid, primaryKey: true),
      SchemaProperty('tittle', RealmPropertyType.string),
